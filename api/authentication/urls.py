...
urlpatterns = [
    ...
    path("fake-socialaccount-connections", TemplateView.as_view(),
    ...
    path("password/reset-token-valid/", apis.PasswordResetKeyValidApi.as_view(),
         name="password_reset_token_valid"),
    path("register/", include(dj_rest_auth_registration_urls)),
    path("register/token-valid/", apis.RegistrationKeyValidApi.as_view(),
         name="register_token_valid"),
    ...
    path("social/google/connect/",
         apis.GoogleConnectApi.as_view(), name="google_connect"),
]
