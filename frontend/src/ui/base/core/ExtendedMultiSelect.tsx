...
export interface ExtendedMultiSelectProps
  ...
  renderValues?: (
    values: {
      value: string, 
      item: ComboboxItem,
      defaultProps: Pick<PillProps, "key" | "withRemoveButton" | "onRemove" | "unstyled" | "className" | "style">,
    }[],
  ) => ReactNode;
}
...
const ExtendedMultiSelect = factory<ExtendedMultiSelectFactory>((_props, ref) => {
  ...
  const { resolvedClassNames, resolvedStyles } = useResolvedStylesApi<ExtendedMultiSelectFactory>({
    props,
    styles,
    classNames,
  });
