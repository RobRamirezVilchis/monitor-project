...
const SmartRetailDashboardLayout = ({ children }: { children: ReactNode }) => {
      ...
      <Tabs color="gray.6" value={currentTab}>
        <div className="md:flex md:items-center pb-2 mb-3 md:mb-6 justify-left 2xl:justify-between">
          <div className="md:flex md:items-center">
            ...
            <Tabs.List>
              <Link href="/monitor/smart-retail/details">
                <Tabs.Tab className="text-lg" value="details">
                  Detalles
                </Tabs.Tab>
              </Link>
              <Link href="/monitor/smart-retail/statistics">
          ...
          <div className="mt-2 md:mt-0 ml-0 md:ml-4 mr-0 2xl:mr-16">
            <Link href={"/monitor/smart-retail/add-client"}>
              <Button
                color="green.7"
...
export default SmartRetailDashboardLayout;
