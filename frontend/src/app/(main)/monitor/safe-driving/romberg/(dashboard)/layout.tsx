...
const RombergDashboardLayout = ({ children }: { children: ReactNode }) => {
      ...
      <Tabs color="gray.6" value={currentTab}>
        <div className="md:flex md:items-center pb-2 mb-3 md:mb-6 justify-left 2xl:justify-between">
          <div className="md:flex md:items-center">
            <h1 className="mb-4 md:mb-0 text-5xl font-bold pr-10 ">Romberg</h1>
            <Tabs.List>
              <Link href="/monitor/safe-driving/romberg/details">
                <Tabs.Tab className="text-lg" value="details">
                  Detalles
                </Tabs.Tab>
              </Link>
              <Link href="/monitor/safe-driving/romberg/statistics">
...
export default RombergDashboardLayout;
