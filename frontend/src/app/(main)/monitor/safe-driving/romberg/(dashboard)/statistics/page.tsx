...
import {
  useRombergAreaPlotData,
  useRombergClientsQuery,
...
const RombergStatisticsPage = () => {
  ...
  const clientsQuery = useRombergClientsQuery({
    refetchOnWindowFocus: false,
  });
  const clients = clientsQuery.data?.map((data) => data.name);

  const areaPlotDataQuery = useRombergAreaPlotData({
    variables: {
...
export default RombergStatisticsPage;
