...
const schema = z.object({
  checkbox: z.boolean(),
  chip: z.boolean(),
  colorInput: z.string().min(1, "The color is required"),
  colorPicker: z.string().min(1, "The color is required"),
  mask: z.string().min(1, "The mask is required"),
  files: z.union([z.custom<File>(), z.array(z.custom<File>()), z.null()]),
  json: z.string().min(1, "The json is required"),
  selectNative: z.string().min(1, "The selectNative is required"),
  ...
  radio: z.boolean(),
  radioGroup: z.string().min(1, "The radioGroup is required"),
  rating: z.number(),
  segmented: z.string(),
  slider: z.number(),
  switch: z.boolean(),
  textarea: z.string().min(1, "The textarea is required"),
  text: z.string().min(1, "The text is required"),

  autocomplete: z.string().min(1, "The autocomplete is required"),
  multiselect: z.array(z.string()).min(1, "The multiselect is required"),
  select: z.string().min(1, "The select is required"),
  tags: z.array(z.string()).min(1, "The tags is required"),
